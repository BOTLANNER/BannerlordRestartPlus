...
namespace BannerlordRestartPlus.Patches.Runtime
{
    public static class CharacterCreationStateExtensions
    {
        ...
        public static CampaignVec2? Position = null;

        public static void FinalizeCharacterCreationInGame(this CharacterCreationState __instance)
        {
            __instance.CharacterCreationManager.ApplyFinalEffects();
            ...
            __instance.Handler.OnCharacterCreationFinalized();
            ...
            var pos = MobileParty.MainParty.Position;
            Campaign.Current.InitializeMainParty();

            MobileParty.MainParty.Position = pos;
            if ((Main.Settings!.PlaceAtOldPosition /*|| pos == Campaign.Current.DefaultStartingPosition*/ || pos == default) && Position != null && Position != default(CampaignVec2))
            {
                MobileParty.MainParty.Position = Position.Value;
